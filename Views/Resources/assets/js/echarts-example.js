...
/*                             Echarts Pie Chart                              */
/* -------------------------------------------------------------------------- */
var echartsPieChartInit = function() {
    var $pieChartEl = document.querySelector('.echart-pie-chart');
    if ($pieChartEl) {
        // Obtener datos dinámicos desde el servidor PHP
        fetch('../../controller/echarts/chart_pie.php')  // Nombre del archivo PHP que obtiene los datos
            ...
            .then(function(data) {
                ...
                var pieData = data.map(function(item) {
                    return {
                        value: parseInt(item.cantidad),  // Convertir a entero la cantidad
                        name: item.Nombre_Rol
                    };
                });
                ...
                var option = {
                    ...
                    // Otras opciones del gráfico (legend, tooltip, etc.)
                };

                // Inicializar Echarts y aplicar la configuración
                var chart = echarts.init($pieChartEl);
                chart.setOption(option);

                // Cambiar el tamaño del gráfico en ventana redimensionada
