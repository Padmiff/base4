        ...
        <form id="form2" onsubmit="event.preventDefault(); showPreview();">
            ...
            <div class="form-step">
                ...
                <div class="form-group">
                    ...
                    <label for="nombre_jefe">Aceptación de responsabilidad *</label>
                    <label for="nombre_jefe">Al firmar esta solicitud, me comprometo a asumir la responsabilidad del cuidado y uso
            ...
            <div id="previewSection" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <img id="preview_evidencia" style="display: none;" alt="Vista previa de evidencia">
                </div>
