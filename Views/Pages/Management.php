            <div class="col-xxl-6 col-lg-12">
                <div class="card h-100">
                    <div class="bg-holder bg-card" style="background-image:url(Views/Resourcesassets/img/icons/spot-illustrations/corner-3.png);">
                    </div>
                            ...
                            <div class="col-auto ps-0">
                                <div class="avatar-group avatar-group-dense">
                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/1-thumb.png" alt="" />

                                    </div>
                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/2-thumb.png" alt="" />

                                    </div>
                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/3-thumb.png" alt="" />
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        <div class="bg-holder bg-card" style="background-image:url(Views/Resourcesassets/img/icons/spot-illustrations/corner-1.png);">
                                        </div>
                                        <!--/.bg-holder-->
                                ...
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        <div class="bg-holder bg-card" style="background-image:url(Views/Resourcesassets/img/icons/spot-illustrations/corner-2.png);">
                                        </div>
                                        <!--/.bg-holder-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="avatar-group avatar-group-dense mb-3">
                                ...
                                <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                                    <img class="rounded-circle" src="Views/Resourcesassets/img/team/4-thumb.png" alt="" />

                                </div>
                                <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                                    <img class="rounded-circle" src="Views/Resourcesassets/img/team/5-thumb.png" alt="" />
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body members-activity scrollbar-overlay">
                            <div class="row g-2 mb-4">
                                ...
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-1.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-2.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">67%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-3.png" alt="..." />
                            ...
                            <div class="row g-2 mb-4">
                                ...
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-4.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">20%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-5.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">67%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-6.png" alt="..." />
                            ...
                            <div class="row g-2 mb-4">
                                <div class="col-12 d-flex align-items-center">
                                    <div class="avatar avatar-xl rounded-circle">
                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/16.jpg" alt="" />

                                    </div>
                                    <h6 class="mb-0 ps-2">Monica Geller</h6>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-7.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-8.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">67%</div>
                                </div>
                                <div class="col-4 position-relative"><img class="w-100" src="Views/Resourcesassets/img/management/activity-9.png" alt="..." />
                                    <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">89%</div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-2xl status-online">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/7.jpg" alt="" />

                                                    </div>
                                                    <div class="flex-1 ms-3">
                                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="Views/Resourcespages/user/profile.html">Gavin Belson</a></h6>
                                        ...
                                        <tr class="border-bottom border-200">
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-2xl status-online">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/9.jpg" alt="" />
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-2xl status-away">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/12.jpg" alt="" />
                                        ...
                                        <tr class="border-bottom border-200">
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-2xl status-online">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/avatar.png" alt="" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-2xl status-online">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/25.jpg" alt="" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group justify-content-end">
                                                    ...
                                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/10.jpg" alt="" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group justify-content-end">
                                                    ...
                                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/13.jpg" alt="" />

                                                    </div>
                                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/5.jpg" alt="" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group justify-content-end">
                                                    ...
                                                    <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                                        <img class="rounded-circle" src="Views/Resourcesassets/img/team/18.jpg" alt="" />
