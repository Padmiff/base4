                    ...
                    <tbody class="list">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalDesbloquear<?php echo htmlspecialchars($usuario['idEmpleado']); ?>">
                                                <span class=" fas fa-lock-open"></span>
                                            </a>
                                            <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalEliminar<?php echo htmlspecialchars($usuario['idEmpleado']); ?>">
