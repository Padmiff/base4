...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        ...
        if ($controller) {
            ...
            header("Location: /base4_ho/Management");
            exit();
        } else {
        ...
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative">
                    ...
                    <!-- <img class="bg-auth-circle-shape-2" src="" alt="" width="150"> -->
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                        <p class="text-white">Don't have an account?<br><a class="text-decoration-underline link-light" href="../Views/register.php">Get started!</a></p>
