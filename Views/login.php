...
<head>
    ...
    <meta name="msapplication-TileImage" content="../Views/Resources/assets/img/favicons/harinera-de-oriente.png">
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        ...
        $controller = AuthenticationController::login($email, $password);

        // Llama a la función de inicio de sesión desde consultas.php
        if ($controller) {
            // Inicio de sesión exitoso, redirigir a la página de gestión o dashboard
            header("Location: /base_ho/Management");
            exit();
        } else {
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                        <p class="pt-3 text-white">¿No tienes una cuenta?<br><a class="btn btn-outline-light mt-2 px-4" href="../Views/register.php">¡Regístrate!</a></p>
                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="login.php" method="POST">
                                            ...
                                            <div class="row flex-between-center">
                                                ...
                                                <div class="col-auto"><a class="fs-10" href="forgot_password.php">¿Olvidaste tu contraseña?</a></div>
                                            </div>
                                            <div class="mb-3">
                                                <button class="btn btn-danger d-block w-100 mt-3" type="submit" name="submit">Ingresar</button>
                                                <?php
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            <h5 class="fs-9">Esquema de color</h5>
