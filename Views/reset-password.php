...
if (isset($_GET['token'])) {
    $token = $_GET['token'];
    error_log("Token recibido en la URL: " . $token);
} else {
...
<body>
    ...
    if (isset($_SESSION['alert_message'])) {
        $alertClass = ($_SESSION['alert_type'] === 'success') ? 'alert-success' : 'alert-danger';
        echo '<div class="alert ' . $alertClass . ' alert-fixed" role="alert" id="alertBlock">
                        <div class="d-flex align-items-center">
                            <div class="bg-' . ($_SESSION['alert_type'] === 'success' ? 'success' : 'danger') . ' me-3 icon-item">
                                <span class="fas ' . ($_SESSION['alert_type'] === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle') . ' text-white fs-6"></span>
                            </div>
                            <p class="mb-0 flex-1">' . $_SESSION['alert_message'] . '</p>
    ...
    <main class="main" id="top">
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape" src="../Views/Resources/assets/img/icons/spot-illustrations/bg-shape.png" alt="" width="250"><img class="bg-auth-circle-shape-2" src="../Views/Resources/assets/img/icons/spot-illustrations/shape-1.png" alt="" width="150">
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                        ...
                                        <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-block fw-bolder" href="../Views/Resources/index.html">falcon</a>
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        <h3>Asigne su contraseña</h3>
                                        <?php ContactsProvidersController::passwordContactoProvider() ?>
                                        <form class="mt-3" action="" method="post">
                                            ...
                                            <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="actualizar">Guardar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
                    <div class="col-4">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../Views/Resources/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span class="label-text">Claro</span></label>
                    </div>
                    <div class="col-4">
                        <input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="theme" />
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../Views/Resources/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span class="label-text"> Oscuro</span></label>
                    </div>
                    <div class="col-4">
                        <input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="theme" />
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../Views/Resources/assets/img/generic/falcon-mode-auto.jpg" alt="" /></span><span class="label-text"> Auto</span></label>
                    </div>
                </div>
            </div>
            <hr />
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2" src="../Views/Resources/assets/img/icons/paragraph.svg" width="20" alt="" />
                <div class="flex-1">
            ...
            <hr />
            <h5 class="fs-9 d-flex align-items-center">Estilo de barra de navegación</h5>
            <p class="fs-10 mb-3">Cambia entre estilos para tu barra de navegación </p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
                    <div class="col-6">
                        <input class="btn-check" id="navbar-style-transparent" type="radio" name="navbarStyle" value="transparent" data-theme-control="navbarStyle" />
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="../Views/Resources/assets/img/generic/default.png" alt="" /><span class="label-text"> Transparente</span></label>
                    </div>
                    <div class="col-6">
                        <input class="btn-check" id="navbar-style-inverted" type="radio" name="navbarStyle" value="inverted" data-theme-control="navbarStyle" />
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="../Views/Resources/assets/img/generic/inverted.png" alt="" /><span class="label-text"> Invertida</span></label>
                    </div>
                    <div class="col-6">
                        <input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle" value="card" data-theme-control="navbarStyle" />
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-card"> <img class="img-fluid img-prototype" src="../Views/Resources/assets/img/generic/card.png" alt="" /><span class="label-text"> Tarjeta</span></label>
                    </div>
                    <div class="col-6">
                        <input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle" value="vibrant" data-theme-control="navbarStyle" />
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="../Views/Resources/assets/img/generic/vibrant.png" alt="" /><span class="label-text"> Vibrante</span></label>
                    </div>
                </div>
            </div>
        </div>
