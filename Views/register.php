...
<body>
                                ...
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                        ...
                                        <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-block fw-bolder" href="../../../index.html">falcon</a>
                                            <p class="opacity-75 text-white">With the power of Falcon, you can now
                                                focus only on functionaries for your digital products, while leaving
                                                the UI design on us!</p>
                                        </div>
                                    </div>
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                        <p class="pt-3 text-white">Have an account?<br><a class="btn btn-outline-light mt-2 px-4" href="../Views/login.php">Log In</a></p>
                                    </div>
                                </div>
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            // Incluir archivo con las funciones necesarias


                                            // Establecer conexión a la base de datos (debes tener $pdo configurado)
                                            ...
                                            if (empty($nombre) || empty($email) || empty($password) || empty($confirm_password)) {
                                                ...
                                                // $result = registerUser($email, $nombre, $password);
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="text-center mt-5"><img class="mb-4" src="../Views/Resources/assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
