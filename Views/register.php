                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-label" for="card-register-checkbox">Acepto los <a href="#!">términos </a>y <a class="white-space-nowrap" href="#!">política de privacidad</a></label>
                                            </div>
                                            <div class="mb-3">
                                                <button class="btn btn-danger d-block w-100 mt-3" type="submit" name="submit">Registrarse</button>
                                            </div>
                                        </form>
                                        ...
                                        <div class="row g-2 mt-2">
                                            <div class="col-sm-12 d-flex justify-content-center"><a class="btn btn-outline-google-plus btn-sm w-50" href="#"><span class="fab fa-google-plus-g me-2" data-fa-transform="grow-8"></span> google</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
